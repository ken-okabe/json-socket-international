...
This is a fork of http://github.com/sebastianseilund/node-json-socket with a fix for international characters.

See https://github.com/sebastianseilund/node-json-socket/issues/47

The credit goes to many contributers including the original author: Sebastian Seilund and who modified the issue:  Harrison Palzewicz @hpalz
...
```
npm install json-socket-international
```
...
```javascript
var net = require('net'),
    JsonSocket = require('json-socket-international');
...
```javascript
var JsonSocket = require('json-socket-international');
